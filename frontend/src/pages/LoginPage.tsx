    ...
    <div>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
        ...
        <div className="rounded-xl border border-gray-200 bg-gray-50 px-4 py-4">
          <p className="text-sm font-semibold text-gray-900">Need to reset your password?</p>
          <p className="text-sm text-gray-500 mt-1">Use the email reset flow and choose a new password from the link we send you.</p>
          <Link
            to="/forgot-password"
            className="mt-3 inline-flex w-full items-center justify-center rounded-lg border border-accent/30 bg-white px-4 py-2.5 text-sm font-medium text-accent hover:bg-accent/5"
          >
