  ...
  return (
    <div className="relative flex items-center justify-between">
      ...
      <div
        ...
        style={{
          width: `${currentIdx >= 0 ? (currentIdx / (TIMELINE.length - 1)) * 100 : 0}%`,
        }}
      />
      ...
      {TIMELINE.map((step, idx) => {
        ...
        return (
          <div key={step} className="flex flex-col items-center gap-2 z-10">
            ...
            <span
              className={`text-xs font-medium hidden sm:block ${done ? 'text-accent' : 'text-gray-400'}`}
            >
              {cfg.label}
            </span>
          </div>
...
export function OrderDetailPage() {
  ...
  if (error || !order) {
    return (
      <div className="w-full max-w-3xl mx-auto px-6 py-20 text-center">
        ...
        <Link
          to="/orders"
          className="inline-flex items-center gap-2 bg-accent text-white px-6 py-2.5 rounded-xl hover:bg-accent-light transition-colors"
        >
  ...
  return (
    <div className="w-full max-w-4xl mx-auto px-6 py-10">
      ...
      <Link
        to="/orders"
        className="inline-flex items-center gap-2 text-gray-500 hover:text-accent transition-colors text-sm mb-8"
      >
        <ArrowLeft className="w-4 h-4" /> Back to Orders
      </Link>
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
        ...
        <div
          className={`inline-flex items-center gap-2 px-4 py-2 rounded-xl border text-sm font-semibold ${statusCfg.bg} ${statusCfg.color}`}
        >
