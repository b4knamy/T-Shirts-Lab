        ...
        <div>
          {product.category && (
            <Link
              ...
              className="text-sm text-accent uppercase tracking-wide font-medium"
            >
          ...
          {product.reviews_count !== undefined && product.reviews_count > 0 && (
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="text-sm text-gray-500">
                {product.average_rating} ({product.reviews_count} review
              ...
              <button
                ...
                className={`flex-1 flex items-center justify-center gap-2 py-3.5 rounded-xl font-semibold text-white transition-all duration-200 shadow-md ${
                  addedToCart
                    ...
                    : 'bg-accent hover:bg-accent-light shadow-accent/25 hover:shadow-accent/40'
                }`}
              >
                {addedToCart ? (
                  <>
